...
<head>
    ...
    <script>
          ...
          function updateClick(did) {
              window.location.href="${pageContext.request.contextPath}/department/updatePage.do?did="+did;
          }
    </script>
</head>
<body>
...
<div id="MainArea">
        ...
        <tbody id="TableData">
          <c:forEach items="${departmentList}" var="department">
              ...
              <td><a href="#" onclick="deleteClick('${department.did}')">删除</a>&nbsp;
                  <a href="#" onclick="updateClick('${department.did}')">修改</a></td>
          </tr>
          </c:forEach>
        </tbody>
    </table>
    ...
    <div id="TableTail">
        <div id="TableTail_inside">
            <a href="${pageContext.request.contextPath}/department/insert.do"><img src="${pageContext.request.contextPath}/css/images/createNew.png"></a>
        </div>
    </div>
</div>
</body>
